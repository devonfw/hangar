  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: Column(
        ...
        children: [
          TooltipMessage(
            message: AppLocalizations.of(context)!.openIdeButtonTooltip,
            child: CustomButton(
          ...
          TooltipMessage(
            message: AppLocalizations.of(context)!.openPipelineButtonTooltip,
            child: CustomButton(
          ...
          const SizedBox(height: 20),
          TooltipMessage(
            message: AppLocalizations.of(context)!.openFeRepoTooltip,
            child: CustomButton(
          ...
          const SizedBox(height: 20),
          TooltipMessage(
            message: AppLocalizations.of(context)!.openBeRepoTooltip,
            child: CustomButton(
