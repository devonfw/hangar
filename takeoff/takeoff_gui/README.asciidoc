...
image::documentation/assets/takeoff_diagram.jpeg[]

== How to use TakeOff GUI

. Open takeoff desktop application.
image::documentation/assets/takeoff_main.jpeg[]

. Create project using "Create" or "QuickStart" buttons.
image::documentation/assets/takeoff_create.jpeg[]
...
image::documentation/assets/takeoff_resources.jpeg[]