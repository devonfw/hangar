...
void main() {
  test("BuildPipelineGCloud to command generates the arguments correctly", () {
    BuildPipelineGCloud buildPipelineGCloud = BuildPipelineGCloud(
        configFile: "configFile",
        pipelineName: "pipelineName",
        language: Language.flutter,
        localDirectory: "localDirectory");
    expect(buildPipelineGCloud.toCommand(), [
      '/scripts/pipelines/gcloud/pipeline_generator.sh',
      '-c',
      'configFile',
      '-n',
      'pipelineName',
  ...
  test(
      "BuildPipelineGCloud to command with all the parameters generates the arguments correctly",
      () {
    BuildPipelineGCloud buildPipelineGCloud = BuildPipelineGCloud(
        configFile: "configFile",
        pipelineName: "pipelineName",
        ...
        machineType: MachineType.E2_HIGHCPU_32);
    expect(buildPipelineGCloud.toCommand(), [
      '/scripts/pipelines/gcloud/pipeline_generator.sh',
      '-c',
      'configFile',
