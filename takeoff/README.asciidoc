...
:url-use-cli:  https://github.com/devonfw/hangar/blob/takeoff-develop/takeoff/takeoff_cli/README.asciidoc
:url-use-gui:  https://github.com/devonfw/hangar/blob/takeoff-develop/takeoff/takeoff_gui/README.asciidoc
