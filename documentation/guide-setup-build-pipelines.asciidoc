...
In this section we will look at how to create our build pipelines in order to compile our code. A script named `build_pipeline_generation.ps1` has been created in order to automate the creation of your build pipeline, this script can be found in the folder \scripts\pipelines\azure-devops.
