...
ifdef::secretVar[  [--secret-vars <secret vars list>]]
ifdef::envVar[  [--env-vars <env vars list>]]
  [-b <branch>] \
...
ifdef::secretVar[    --secret-vars                         Environment variable that needs to be set as secret needed for this pipeline. (list in the format of "var1=val1 var2=val2 ...")]
ifdef::envVar[    --env-vars                            Environment variable needed for this pipeline. (list in the format of "var1=val1 var2=val2 ...")]
