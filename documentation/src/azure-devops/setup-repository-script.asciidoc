...
:usage_required_flags:  -o <organization> \ + \
    -p <project>

:usage_optional_flags: [-u <public>]
:flags_required_flags: -o, --org                   [Required] Name of the Azure DevOps organization. \ -p, --project               [Required] Name of the Google Cloud project.
:flags_optional_flags: -u, --public                           Repository scope. Private by default
