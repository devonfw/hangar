...
The script located at `/scripts/create-user/aws/create-user.sh` will assist you in the creation of a user and a group, it will attach the required policies to this group and add the user to it.
