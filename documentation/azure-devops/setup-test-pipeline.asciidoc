...
```
./pipeline_generator.sh -c ./templates/test/test-pipeline.cfg -n node-project-test -l node -a ./.pipelines/target/ -d C:/Users/zchriste/IdeaProjects/hangar-tezt --build-pipeline-name node-project-build -b master -w
```
