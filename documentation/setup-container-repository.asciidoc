...
* The scope of this section is to setup/create container registry with Docker Hub, AWS and Azure.
* By the end of this guide, we get the container registry name/url as output which can be used by hangar package pipeline.
