...
This command creates a repository on Azure and clones it into our local directory, then it creates the necessary branches and branch policies (see after for more information).
